...
Settings Module
---------------
Provides a GUI interface for configuring gesture control settings including:
- Hand gesture modes (keyboard/mouse control for left/right hands)
- Facial gesture modes (blink detection for left/right eyes)

The settings are persisted to config.json for use across application sessions.
"""
...
class Settings:
    def __init__(self, top):
        ...
        def load_and_resize_image(path, size=(80, 80)):
            """Load and resize an image for icon display
    ...
    def swap_hand_modes(self):
        """Swap the control modes between left and right hands"""
    ...
    def swap_facial_modes(self):
        """Swap the click actions between left and right eye blinks"""
    ...
    def save_settings(self):
        """Save current settings to config.json and close the window"""
        config = {
