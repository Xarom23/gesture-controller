...
Principal Module
-----------------
Main application window providing the primary user interface for the gesture control system.
Includes menu bar navigation, video canvas display, and integration with camera and gesture detection.

Features:
- Video feed display with toggle capability
- Landmark visualization controls
- Settings and about page navigation
- Gesture control enable/disable functionality
"""
...
class Principal:
    def __init__(self, top=None):
        ...
        Args:
            top: Root Tkinter window instance
        """
        ...
        # Canvas configuration for video display
        ...
        # Initialize camera handler and start if canvas is visible
    ...
    def toggle_landmarks(self):
        """Toggle landmarks visibility in the video feed"""
